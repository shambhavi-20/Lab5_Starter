...
test('Correct Phone Number 1: 123-456-4890', () => {
  expect(isPhoneNumber('123-456-7890')).toBe(true);
});

test('Correct Phone Number 2: (213)456-4890', () => {
  expect(isPhoneNumber('(213)456-4890')).toBe(true);
});

test('Wrong Phone Number 1: 123-45-4890', () => {
  expect(isPhoneNumber('123-45-7890')).toBe(false);
});

test('Correct Phone Number 2: (213)4564890', () => {
  expect(isPhoneNumber('(213)4564890')).toBe(false);
});
